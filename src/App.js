...
const App = () => {
  let Links = [
    ...
    { name: "Services", link: "#service-section" },
    { name: "Contact", link: "/" },
    { name: "FAQ", link: "/" },
  ];
  ...
  React.useEffect(()=>{
    document.title = "Agrodroid | Home";
  },[])

  return (
    <>
      <header className="w-[100%] h-[100vh] relative z-10" id="header">
      
        <div className="w-full fixed top-0 left-0 font-[Poppins] md:h-auto">
          <div className="lg:shadow-sm md:flex items-center justify-between bg-white py-4 md:px-10 px-7">
            <a
              href="/"
              className="font-bold text-2xl cursor-pointer flex items-center font-[Poppins] 
      text-gray-800"
            >
              <span className="text-3xl mr-1 pt-2">Agrodroid</span>
            </a>
            ...
            <ul
              className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 ease-in ${
        ...
        <div id="home-section" className="pt-20 h-[100vh] w-[100%]">
      ...
      <main className="font-[Poppins] min-h-screen" id="about-us">
        {/* About Us Section */}
        <section
          className="w-[100%] min-h-screen bg-[#FFFFFF] text-black px-4 pb-2 pt-16"
          id="about-section"
        >
        ...
        <section id="vision-and-mission" className="w-[100%] min-h-screen bg-white px-4 pb-2 pt-16">
            ...
            <div className="outer-box  flex flex-row my-3 justify-center items-center flex-wrap md:flex-nowrap space-y-20 md:space-y-0">
              ...
              <div className="inner w-[90%] md:w-[50%] h-[auto] flex flex-col items-center justify-center">
                    <img src={Target} alt="Mission" className="w-[90%] lg:w-[40%] "/>
        ...
        {/* Our Team Starts */}
        <section id="tema-section" className="w-[100%] min-h-screen px-4 pb-2 pt-8">
          <div className="logo w-[15%] mx-auto py-3">
              ...
              teamMembers.map((each)=>{
                return (
                  <div key={each.key} className="each-card flex flex-col w-[280px] bg-white  hover:scale-[1.05] hover:duration-300 hover:ease-in-out py-3 m-auto">
                    <img src={each.name === "Mahesh Vuppu" ? Partner1 : each.name === "Adhnan Mahboob.M" ? Partner2 : each.name === "Jeshwanth Reddy.K" ? Partner3 : each.name === "Naveen Gadala" ? Partner4 : ""} alt="member" className="object-cover my-1 w-[80%] h-[220px] rounded-[50%] m-auto shadow-sm "/>
          ...
          <div className="my-7 mx-auto w-[100%] flex flex-col justify-center items-center space-y-5">
            ...
            <div className="text-center font-medium text-xl">We have a Passionate technical team of <span className="font-bold text-2xl ">11 members</span> who are working on this project.</div>
          </div>
