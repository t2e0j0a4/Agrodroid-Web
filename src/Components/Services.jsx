...
const Services = () => {
  return (
    <main
      id="services"
      className="w-[100%] h-[100%] md:min-h-screen mx-auto pt- md:pt-16 overflow-x-hidden md:overflow-y-hidden"
    >
      <section className="w-[100%] h-[100%]  ">
        <div className="overflow-hidden w-[100%] lg:w-[50%] mx-auto pb-8 pt-4 md:pt-4 md:pb-8 z-[-1] flex justify-center items-center">
          ...
          />
          <span className="absolute text-[#004346] font-leaguespartan lg:text-3xl sm:text-[7vmin] text-center select-none" data-aos="zoom-in" data-aos-duration="700" data-aos-offset="200">
            Services
          </span>
        </div>
