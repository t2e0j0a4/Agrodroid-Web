...
import about from "../Images/AgroDr_Main.png";
...
import manojkumar from "../Images/Manoj Kumar Mentor.svg";
  ...
  return (
    <main className="font-[Poppins] h-[100%] overflow-x-hidden" id="about-us">
        ...
        <section id="vision-and-mission" className="w-[100%] min-h-screen px-4 pb-2 pt-16 text-[#252525]">
            ...
            <div className="outer-box  flex flex-row my-3 justify-center items-center flex-wrap md:flex-nowrap space-y-20 md:space-y-0">
              <div className="inner w-[90%] md:w-[50%] h-[auto] flex flex-col items-center justify-center">
                    ...
                    <div className="sub-head-line text-md w-[90%] sm:w-[70%] text-center font-semibold">Enlight the technology in farming to make it independent of labour.</div>
              </div>
              ...
              <div className="inner w-[85%] md:w-[50%] h-[auto] flex flex-col items-center justify-center">
                    ...
                    <div className="sub-head-line text-md w-[90%] sm:w-[70%] text-center font-semibold">To offer technical solutions for smart agriculture as a service to grow up its Production quality and revenues for farmers with 0% mental stress.</div>
              </div>
            </div>
        ...
        <section id="team-section" className="w-[100%] min-h-screen px-4 pb-2 pt-8">
          ...
          <div className="w-[100%] h-[100%] flex flex-col items-center justify-center my-3 gap-y-4 mt-5">
